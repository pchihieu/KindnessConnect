  ...
  return (
    <div className="joinInvitation">
      <div className="ji--content_container">
        ...
        Tại Kindness, chúng tôi đặt lòng nhân ái ở trung tâm mọi hoạt động của chúng tôi. Chúng tôi tin rằng bằng sự đoàn kết và hỗ trợ lẫn nhau, chúng ta có thể thay đổi cuộc sống và tạo nên một thế giới tốt đẹp hơn.
        </div>
